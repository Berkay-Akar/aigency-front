  ...
  return (
    <div className="p-5 md:p-8 pb-24 md:pb-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-white mb-0.5">Posts</h1>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <p className="text-white/20 text-xs mb-6">
            Generate content in Studio to get started
          </p>
          <Link
            href="/studio"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium transition-colors"
          >
            <Plus className="w-4 h-4" />
            Go to Studio
          </Link>
